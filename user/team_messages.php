                ...
                <section class="messages-panel">
                    <div class="conversation-header">
                        ...
                        <div>
                            ...
                            <p class="muted">
                                <?php echo count($members); ?> members &middot; Leader: <?php echo htmlspecialchars($selectedTeam['leader_name'] ?? "Not assigned"); ?>
                            </p>
                        </div>
                    </div>
                            ...
                            <?php foreach ($messages as $message) { ?>
                                ...
                                <div class="message-bubble <?php echo $isMine ? 'mine' : 'theirs'; ?>">
                                    <strong>
                                        ...
                                        <?php echo $senderLabel !== "" ? ' &middot; ' . htmlspecialchars($senderLabel) : ''; ?>
                                    </strong>
